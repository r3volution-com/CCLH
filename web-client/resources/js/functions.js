...
function changeLRLayer(type){
	if (type == "register"){
		if (changeLayer('#lr-layer', 'pages/register.html', 'change', function() {
			$("#lr-button").html('<a href="javascript:void(0)" onclick="changeLRLayer(\'login\')" class="waves-effect waves-light btn"><i class="material-icons left">account_box</i>Entra</a>');
		}));
	} else if (type == "login"){
		if (changeLayer('#lr-layer', 'pages/login.html', 'change', function() {
			$("#lr-button").html('<a href="javascript:void(0)" onclick="changeLRLayer(\'register\')" class="waves-effect waves-light btn"><i class="material-icons left">add_box</i>Registrate!</a>');
		}));
